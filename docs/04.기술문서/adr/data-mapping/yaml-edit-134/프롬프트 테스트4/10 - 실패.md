...
# [FIXED] Corrected KAKAO_REDIRECT_URI to match context specification
  KAKAO_REDIRECT_URI: http://localhost:8080/members/login/oauth2/code/kakao
# [FIXED] Corrected FRONT_DOMAIN to match context specification
...
spec:
  type: ClusterIP
  ports:
  # [FIXED] Corrected port to 8084 to match the internal service port
  - port: 8084
    targetPort: 8084
  selector:
    app: user-service
