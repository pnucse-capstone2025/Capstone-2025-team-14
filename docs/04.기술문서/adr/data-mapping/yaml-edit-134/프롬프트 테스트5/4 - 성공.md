...
metadata:
  ...
  labels:
    ...
    tier: backend
# [FIXED] Moved from stringData to data and ensured Base64 encoding as per security policy.
data:
  ...
  template:
    ...
    spec:
      ...
      - name: order-service
        ...
        # [FIXED] Added missing SERVICE_WISH_URI environment variable from ConfigMap.
        ...
        - name: KAKAO_CLIENT_ID
          valueFrom:
            secretKeyRef:
              name: gift-secret
              key: KAKAO_CLIENT_ID
        # [FIXED] Added missing KAKAO_CLIENT_SECRET environment variable from Secret.
        - name: KAKAO_CLIENT_SECRET
          valueFrom:
            secretKeyRef:
              name: gift-secret
