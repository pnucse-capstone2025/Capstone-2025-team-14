...
metadata:
  ...
  labels:
    ...
    tier: backend
# [FIXED] Changed from stringData to data for security compliance
data:
  ...
  template:
    ...
    spec:
      ...
      - name: order-service
        ...
        # [FIXED] Added missing environment variable for SERVICE_WISH_URI
        - name: FRONT_DOMAIN
          valueFrom:
            configMapKeyRef:
              name: gift-config
        ...
        - name: KAKAO_CLIENT_SECRET
          valueFrom:
            secretKeyRef:
              name: gift-secret
              key: KAKAO_CLIENT_SECRET
        # [FIXED] Added missing environment variable for KAKAO_CLIENT_SECRET
        resources:
          requests:
            cpu: "100m"
            memory: "512Mi"
