...
metadata:
 ...
 labels:
   ...
   tier: backend
stringData: # 민감 정보는 Base64로 인코딩됩니다
...
| ----------- | ---------- | ---------------------------------------------------------------------- |
| —           | —          | 제공된 YAML에는 `# From source_X` 주석이 없어 매핑할 항목이 없습니다. 주석이 달린 부분만 표에 포함됩니다. |


## 특징: secret에서 stringData로 넣어줘서 카카오 로그인이 X. data로 바꿔주니 잘 된다. stringData쓰지 말라고 했는데, 왜 쓰는걸까