...
# [FIXED] Changed from stringData to data for Secret values as per policy.
...
# [FIXED] Corrected KAKAO_REDIRECT_URI and FRONT_DOMAIN values.
      ...
      - name: user-service
        ...
        resources:
          ...
          limits:
            cpu: "1000m"
            memory: "1Gi"
# [FIXED] Corrected metadata.name and matchLabels.app to user-service.
...
spec:
  ...
  selector:
    app: user-service
# [FIXED] Corrected service name and port for user-service.
