...
metadata:
  ...
  labels:
    ...
    tier: backend
# [FIXED] Changed 'stringData' field to 'data' as per the policy
data:
...
# [FIXED] Corrected the 'KAKAO_REDIRECT_URI' value to match the source of truth
  KAKAO_REDIRECT_URI: http://localhost:8080/members/login/oauth2/code/kakao
# [FIXED] Corrected the 'FRONT_DOMAIN' value to match the source of truth
