...
metadata:
 ...
 labels:
   ...
   app: secret
data:
 JWT_SECRET: WW4ya2ppYmRkRkFXdG5QSjJBRmxMOFdYbW9oSk1DdmlnUWdnYUV5cGE1RT0= # Base64 encoded JWT secret [From source_5]
 KAKAO_CLIENT_ID: YWMyMGQ4NGY5N2I2NzlmMGJiZDlhODA2NWJhODIzZjM= # Base64 encoded Kakao Client ID [From source_5]
 KAKAO_CLIENT_SECRET: RnczSmlMNVBrcGV2WFZaOU9pVk04YmZiZ0hVUEQ1RUE= # Base64 encoded Kakao Client Secret [From source_5]
---
apiVersion: v1
kind: ConfigMap
metadata:
...
| --------------------------------------------------------------------------------------------------- | ---------- | ----------------------------- |
| `gift-secret.Secret.data.JWT_SECRET = WW4ya2ppYmRkRkFXdG5QSjJBRmxMOFdYbW9oSk1DdmlnUWdnYUV5cGE1RT0=` | source\_5  | Base64 인코딩된 JWT 시크릿 값         |
| `gift-secret.Secret.data.KAKAO_CLIENT_ID = YWMyMGQ4NGY5N2I2NzlmMGJiZDlhODA2NWJhODIzZjM=`            | source\_5  | Base64 인코딩된 카카오 Client ID     |
| `gift-secret.Secret.data.KAKAO_CLIENT_SECRET = RnczSmlMNVBrcGV2WFZaOU9pVk04YmZiZ0hVUEQ1RUE=`        | source\_5  | Base64 인코딩된 카카오 Client Secret |
